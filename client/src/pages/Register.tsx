      ...
      <div key={name} className="relative">
        ...
        {type === "select" ? (
          <select
            ...
            className={`w-full px-4 py-3 rounded-xl font-medium text-gray-900 placeholder-gray-400 transition-all duration-300 border-2 outline-none cursor-pointer appearance-none bg-white pr-10 ${
              hasError
